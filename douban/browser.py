...
def doubanfm_search():
    ...
    body = browser.find_element_by_tag_name('body')
    search_results = json.loads(body.text)
    ...
    for song in items:
        ...
        print('Album title: ' + song['albumtitle'])
        print('id: ' + song['id'])
        print('channel: ' + song['channel'])
        print('sid: ' + song['sid'])
        print('artist name: ' + song['artist_name'])
        print('Album title2: ' + song['album_title'])
        singers = song['singers']
        print('url: ' + song['url'])
        print('length: ' + str(song['length']))
        print('kbps: ' + song['kbps'])
        
    songlist = search_results[3]['items']
    for song in songlist:
        url = 'https://douban.fm/j/v2/songlist/%s/?kbps=192' % song['id']
        print('songlist title: ' + song['title'])
        print('songlist url: ' + url)
